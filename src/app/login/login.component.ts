...
export class LoginComponent {
  ...
  modalMessage: string = '';
  check: string = '';
  showToast: boolean = false; // New property for showing/hiding the toast
    ...
    try {
      ...
      if (error) {
        ...
        if (data) {
          ...
          this.showToast = true; // Show the toast after successful login
          // Delay the navigation to the dashboard
          setTimeout(() => {
